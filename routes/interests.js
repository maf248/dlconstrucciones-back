...
const storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        ...
        return cb(null, 'Interes' + '_' + Date.now() + path.extname(file.originalname));
    },
});
...
router.post('/create', adminWebTokenMiddleware, upload.single('image'), interestValidate, interestsController.create);
router.patch('/edit/:id', adminWebTokenMiddleware, upload.single('image'), interestValidate, interestsController.edit);
router.delete('/delete/:id', adminWebTokenMiddleware, interestsController.delete);
